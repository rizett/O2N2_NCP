...
% EDIT by R Izett (rizett@eoas.ubc.ca) UBC (May 2019) to change gamma, Ac, Ap coefficients
% to case that EXCLUDES He
% Version: 13 May 2019
...
%RI 2019 edit: use coefficients when He was excluded (since old He sol. was used in the
%paper) (table 2)
Ac = 8.44e-11;
Ap = 3.75e-3;
gammaG = 0.98;
